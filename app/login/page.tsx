      ...
      <div className="flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-20">
        ...
        <div className="mx-auto mt-16 w-full max-w-sm">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button className="rounded-lg border border-slate-200 py-2.5 text-sm text-slate-700 hover:bg-slate-50">Google</button>
            <button className="rounded-lg border border-slate-200 py-2.5 text-sm text-slate-700 hover:bg-slate-50">Microsoft</button>
            <button className="rounded-lg border border-slate-200 py-2.5 text-sm text-slate-700 hover:bg-slate-50">SSO</button>
          </div>

          <p className="mt-6 text-sm text-slate-500">
            Don&apos;t have an account?{' '}
            <Link href="#" className="font-medium text-violet-600 hover:text-violet-700">Request a demo</Link>
          </p>
        </div>
